...
class ExaminationsController extends Controller
{
    ...
    public function exam_schedule(Request $request)
    {
        ...
        if(!empty($request->get('exam_id')) && !empty($request->get('class_id')))
        {
            ...
            foreach($getSubject as $value)
            {
                ...
                $ExamSchedule = ExamScheduleModel::getRecordSingle($request->get('exam_id')
                ,$request->get('class_id'),$value->subject_id);
        ...
        return view('admin.examinations.exam-schedule',$data);
    }
    ...
    public function submit_marks_register(Request $request)
    {
       ...
       {
       $json['message'] = "Total marks is more than full Marks. Please Correct it.";
       }
    ...
    {
        $json['message'] = "Yor total marks is greater than full Marks";
    }
    ...
    public function marks_grade_insert(Request $request)
    {
       ...
       $mark->save();
        return redirect('admin/examinations/marks_grade')->with('success',"Data inserted Successfully.");
    }
    ...
    public function marks_grade_update($id,Request $request)
    {
       ...
       $mark->created_by = Auth::user()->id;
       $mark->save();
        return redirect('admin/examinations/marks_grade')->with('success',"Data Updated Successfully.");
    }
    ...
    public function marks_grade_delete($id)
    {
        ...
        $mark->is_delete = 1;
        $mark->save();
        return redirect()->back()->with('warning','Grade Successfully deleted');
    }
