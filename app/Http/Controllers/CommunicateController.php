...
class CommunicateController extends Controller
{
    ...
    public function InsertNoticeBoard(Request $request)
    {
        ...
        return redirect('admin/communicate/notice_board')->with('success', "Notice Successfully sent");
    }
    ...
    public function UpdateNoticeBoard($id,Request $request)
    {
        ...
        return redirect('admin/communicate/notice_board')->with('success', "Notice Successfully Updated");
    }
