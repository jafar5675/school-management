                                            ...
                                            <tr>
                                                ...
                                                <td style="min-width:150px;">
                                                    <a class="btn btn-success btn-sm"
                                                        href="{{ url('teacher/homework/homework/edit/' . $value->id) }}">Edit</a>
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ url('teacher/homework/homework/delete/' . $value->id) }}">Delete</a>
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ url('teacher/homework/homework/submitted/' . $value->id) }}">Submitted
                                                        Homework</a>
                                                </td>
                                            </tr>
                                        @empty
