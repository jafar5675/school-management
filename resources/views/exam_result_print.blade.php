...
<body>
    <div id="page">
        <table style="width:100%; text-align:center">
            <tr>
                <td width="5%"></td>
                <td width="15%"><img style="width:80px;" src="{{ $getSetting->getLogo() }}" alt="logo"></td>
                <td align="left">{!! $getSetting->school_name !!}</td>
            </tr>
        </table>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td width="20%" valign="top">
                    <img src="{{ $getStudent->getProfileDirect() }}" alt="student pic" style="border-radius:6px;"
