    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>My Exam Result<span style="color:blue;"> ({{ $getStudent->name }}
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-primary btn-sm float-right" target="_blank"
                                        href="{{ url('parent/my_exam_result/print?exam_id=' . $value['exam_id'] . '&student_id=' . $getStudent->id) }}">Print</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table">
