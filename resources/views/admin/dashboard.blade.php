                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>{{ number_format($getTotalFees, 2) }}TK</h3>
                            ...
                            <a href="{{ url('admin/fees_collection/collect_fees_report') }}" class="small-box-footer">More
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>{{ number_format($getTotalTodayFees, 2) }}TK</h3>
