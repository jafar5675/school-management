            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('admin/assign_class_teacher/add') }}" class="btn btn-primary">Assign New Class
                            Teacher</a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">Search Assinged Class Teacher</h2>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td> <a href="{{ url('admin/assign_class_teacher/edit/' . $value->id) }}"
