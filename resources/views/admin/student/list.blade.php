                    ...
                    <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ Request::get('blood Group') }}" name="blood Group"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form style="float:right;" action="{{ url('admin/student/export_excel') }}"
                                    method="post">
                                    @csrf
                                    <input type="hidden" name="name" value="{{ Request::get('name') }}">
                                    <input type="hidden" name="last_name" value="{{ Request::get('last_name') }}">
                                    <input type="hidden" name="email" value="{{ Request::get('email') }}">
                                    <input type="hidden" name="adimission_number"
                                        value="{{ Request::get('adimission_number') }}">
